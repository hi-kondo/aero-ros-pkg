...
namespace aero
{
  namespace controller
  {
    ...
    const static size_t AERO_DOF = 26;
    const static size_t AERO_DOF_UPPER = 24;
    ...
    const static size_t CAN_R_HAND_Y = 10;
    const static size_t CAN_R_THUMB = 11;

    const static size_t CAN_L_SHOULDER_P = 12;
    const static size_t CAN_L_SHOULDER_R = 13;
    const static size_t CAN_L_ELBOW_Y = 14;
    const static size_t CAN_L_ELBOW_P = 15;
    const static size_t CAN_L_WRIST_Y = 16;
    const static size_t CAN_L_WRIST_TOP = 17;
    const static size_t CAN_L_WRIST_BOTTOM = 18;
    const static size_t CAN_L_HAND_Y = 19;
    const static size_t CAN_L_THUMB = 20;

    const static size_t CAN_WAIST_RIGHT = 21;
    const static size_t CAN_WAIST_LEFT = 22;
    const static size_t CAN_WAIST_Y = 23;
